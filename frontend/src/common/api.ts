...
import {ICreateProductDto, ICreatePromotionDto, IOrderItem, IUpdateOrder, IUpdateProductDto, IUpdatePromotionDto } from "./interface";
...
export const promotionListApi = async (page: number=1, limit: number=10) => {
  const response = await fetch(
    `${apiUrl}/promotion/list?page=${page}&limit=${limit}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const orderListApi = async (page: number=1, limit: number=10) => {
  const response = await fetch(
    `${apiUrl}/order/list?page=${page}&limit=${limit}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const editorderApi = async (body: IUpdateOrder, id: number) => {
